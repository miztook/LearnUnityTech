Shader "TERA/Character/Heroic" {
    Properties {
        ...
        _EMInt("Emission Intensity", Range(0,5)) = 1
...
/////// Diffuse:
                half NdotLq = min(attenuation,NdotL) * 0.8 * equiprange;
...
//////// Emissive:
                fixed3 emission = _SpecularmapRGBA_var.rgb * _MatMask_var.g * _EMInt;
				//fixed3 emission = pow(_SpecularmapRGBA_var.rgb * _MatMask_var.g, 1 / _EMInt);
/// Final Color:
