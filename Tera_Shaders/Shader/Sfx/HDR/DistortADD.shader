...
Shader "TERA/Fx/HDX/distort_add" {
Properties {
...
{
	//noise effect
	fixed4 mask = tex2D(_MaskTex, i.uvmain);
	...
	half4 final_color = 2.0f * i.color * _TintColor * tex2D( _MainTex, i.uvmain);
    final_color.a *= mask.a * _TintColor.a * i.color.a;
	return final_color;
}
ENDCG
		}
