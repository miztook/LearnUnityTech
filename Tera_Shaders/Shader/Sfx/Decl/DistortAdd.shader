...
Shader "TERA/Fx/Decl/DistortAdd" {
Properties {
...
{
	fixed4 alpha = tex2D(_RangeTex, i.uvmain);
	...
	i.uvmain += ((offsetColor1.r + offsetColor2.r) - 1) * _ForceX;
	i.uvmain += ((offsetColor1.r + offsetColor2.r) - 1) * _ForceY;
	fixed4 color = 2.0f * i.color * _TintColor * tex2D( _MainTex, i.uvmain);
	
	color.a = alpha * _TintColor.a;
	//color.a = alpha;
