...
Shader "TERA/Fx/RFX4/DistortionParticles" {
Properties {
	...
	SubShader {
		...
		Pass {
			...
			half4 frag( v2f i ) : SV_Target
			{
				...
				clip(alphaBump - 0.1);
				offset = offset * _BumpAmt * _GrabTextureTERA_TexelSize.xy * i.color.a;
				i.uvgrab.xy = offset * i.uvgrab.z + i.uvgrab.xy;
				half4 col = tex2Dproj( _GrabTextureTERA, UNITY_PROJ_COORD(i.uvgrab));
