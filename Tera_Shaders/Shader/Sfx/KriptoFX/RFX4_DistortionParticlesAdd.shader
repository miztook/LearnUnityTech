...
Shader "TERA/Fx/RFX4/DistortionParticlesAdditive" {
	Properties {
...
#include "UnityCG.cginc"
				...
				sampler2D _BumpTex;
				float _BumpAmt;
				sampler2D _GrabTextureTERA;
				float4 _GrabTextureTERA_TexelSize;
				float4 _BumpTex_ST;
				float4 _MainTex_ST;
				float4 _TintColor;
				float _FrontColor;
				...
				half4 frag( v2f i ) : COLOR
				{
					...
					offset = offset * _BumpAmt * _GrabTextureTERA_TexelSize.xy * i.color.a * _TintColor.a;
					i.uvgrab.xy = offset * i.uvgrab.z + i.uvgrab.xy;
					float4 col = tex2Dproj( _GrabTextureTERA, UNITY_PROJ_COORD(i.uvgrab));
